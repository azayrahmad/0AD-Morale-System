...
Morale.prototype.CheckMoraleDesertTimer = function()
{
	...
	let cmpTimer = Engine.QueryInterface(SYSTEM_ENTITY, IID_Timer);
	this.desertTimer = cmpTimer.SetInterval(this.entity, IID_Morale, "Desert", this.desertTime, this.desertTime, null);
};

/*
 * Handle effect when unit deserts i.e set to Gaia
 */
