...
function displaySingle(entState)
{
	...
	let moraleSection = Engine.GetGUIObjectByName("moraleSection");
	...
	let sectionPosMorale = Engine.GetGUIObjectByName("sectionPosMorale");
	...
	if (showHealth)
	{
		...
		moraleSection.size = sectionPosMorale.size;
		...
		if (showMorale)
		{
			...
			Engine.GetGUIObjectByName("moraleStats").caption = sprintf(translate("%(morale)s / %(maxMorale)s"), {
